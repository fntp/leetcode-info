...
public enum CodeEnum {
    ...
    ERROR_YIDA_USER(20225,"获取宜搭用户数据异常"),
    ERROR_YIDA_USERID(20226,"获取宜搭用户ID异常"),
    ERROR_SEND_SMS_RETURN(20227, "发送验证码失败!"),
    ERROR_HISTORY_ROUTE(20228, "近14天途径地不能包含特殊字符，请检查"),
    ERROR_PERSON_SIGN(20229, "承诺人签名信息异常"),
    ERROR_VERIFY_CODE_RETURN(20230, "获取行程码失败!"),
    ERROR_PERSON_INFO_GET(20231, "获取承诺人乡镇信息失败!"),
    ERROR_SEND_DING_MESSAGE(20232, "发送Ding消息失败!"),
    ...
    EXCEPTION_FIND_NULL_PERSON(20904,"无法获得当前用户的所属乡镇信息"),
    // 204xx 特殊
